 ...
 */
metadata {
	definition (name: "Vesternet VES-ZB-WAT-023 Water Sensor", namespace: "Vesternet", author: "Vesternet", importUrl: "https://raw.githubusercontent.com/vesternet/hubitat-zigbee-device-drivers/main/Vesternet%20VES-ZB-WAT-023%Water%20Sensor.groovy") {
        ...
        fingerprint profileId: "0104", endpointId: "01", inClusters: "0000,0001,0003,0500,0020,0B05", outClusters: "0019", model: "WaterLeakageSensor-ZB3.0", manufacturer: "Shyugj"
	}
	preferences {
...
def getIASEvents(description) {
    ...
    if (description.startsWith("zone status")) {
        ...
        if (zoneStatus != null) {
            ...
            def waterState = alarmState ? "wet" : "dry"
            def descriptionText = "${device.displayName} water is ${waterState}"        
            logText(descriptionText)
            events.add([name: "water", value: waterState, descriptionText: descriptionText])  
        }
        else {
