...
metadata {
    definition(name: 'Vesternet VES-ZB-WAL-006 1 Zone Wall Controller', namespace: 'Vesternet', author: 'Vesternet', importUrl: 'https://raw.githubusercontent.com/vesternet/hubitat-zigbee-device-drivers/main/Vesternet%20VES-ZB-WAL-006%201%20Zone%20Wall%20Controller.groovy') {
        ...
        command 'createGroupBinding', [[name: 'Cluster*', type: 'ENUM', constraints: ['On/Off Cluster (0006)', 'Level Cluster (0008)'], description: 'Select Cluster to bind on this device.'], [name:'Group ID*', type: 'NUMBER', description: 'Enter the Group ID that you wish to bind to (1-65527).']]
        command 'removeGroupBinding', [[name: 'Cluster*', type: 'ENUM', constraints: ['On/Off Cluster (0006)', 'Level Cluster (0008)'], description: 'Select Cluster to unbind on this device.'], [name:'Group ID*', type: 'NUMBER', description: 'Enter the Group ID that you wish to unbind from (1-65527).']]
        command 'createDeviceBinding', [[name: 'Cluster*', type: 'ENUM', constraints: ['On/Off Cluster (0006)', 'Level Cluster (0008)'], description: 'Select Cluster to bind on this device.'], [name:'Device IEEE Address*', type: 'STRING', description: 'Enter the Device IEEE Address that you wish to bind to.'], [name:'Destination Endpoint ID*', type: 'NUMBER', description: 'Enter the Destination Endpoint ID that you wish to bind to (0-255).']]
        ...
        fingerprint profileId: '0104', endpointId: '01', inClusters: '0000,0001,0003,0B05,1000', outClusters: '0003,0004,0005,0006,0008,0019,0300,1000', manufacturer: 'Sunricher', model: 'ZGRC-KEY-007', deviceJoinName: 'Vesternet VES-ZB-WAL-006 1 Zone Wall Controller'
        ...
        fingerprint profileId: '0104', endpointId: '01', inClusters: '0000,0001,0003,0B05,1000', outClusters: '0003,0004,0005,0006,0008,0019,0300,1000', manufacturer: 'Sunricher', model: 'ZG2833K2_EU07', deviceJoinName: 'Vesternet VES-ZB-WAL-006 1 Zone Wall Controller'
    }
    preferences {
