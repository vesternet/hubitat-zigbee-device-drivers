/**
 *	Vesternet VES-ZB-HLD-017 High Load Switch
 * 
 */
metadata {
	definition (name: "Vesternet VES-ZB-HLD-017 High Load Switch", namespace: "Vesternet", author: "Vesternet", importUrl: "https://raw.githubusercontent.com/vesternet/hubitat-zigbee-device-drivers/main/Vesternet%20VES-ZB-HLD-017%20High%20Load%20Switch.groovy") {
		capability "Switch"		
		capability "Actuator"
        ...
        fingerprint profileId: "0104", endpointId:"01", inClusters: "0000,0003,0004,0005,0006,0702,0B04,0B05,1000", outClusters: "0019", manufacturer: "Sunricher", model: "ON/OFF -M", deviceJoinName: "Vesternet VES-ZB-HLD-017 High Load Switch"            
	}
	preferences {
