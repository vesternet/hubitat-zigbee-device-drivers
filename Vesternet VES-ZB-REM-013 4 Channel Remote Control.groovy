    ...
    if (!(descriptionMap.profileId) || (descriptionMap.profileId && descriptionMap.profileId == '0104') || (descriptionMap.profileId && descriptionMap.profileId == '0000')) {
        if (descriptionMap.profileId && descriptionMap.profileId == '0000') {
            ...
            if (endpoint == 1) {
                ...
                switch (descriptionMap.command) {
                    case '04':
                        sceneCommand = 'store scene'
                        break
                    case '05':
                        sceneCommand = 'recall scene'
                        break
                }
                if (descriptionMap.command == '04' || descriptionMap.command == '05') {
                    ...
                    if (sceneData == '01' || sceneData == '02') {
                        ...
                        if (descriptionMap.command == '04') {
                            buttonEvent = 'held'
                        }
                        logDebug("button event is ${buttonEvent}")
                        events.add(buttonAction(buttonEvent, buttonNumber, 'physical'))
                    }
                    else {
